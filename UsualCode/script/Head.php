...
//图标
echo '<link href="static/favicon_32*32.ico" rel="icon">';

//jquery解析库
echo '<!--<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.js"></script>-->';
echo '<script type="text/javascript" src="./script/js/jquery.min.js"></script>';
...
echo '<script type="text/javascript" src="./script/js/CryptoJS/rollups/aes.js"></script>';
echo '<script type="text/javascript" src="./script/js/CryptoJS/rollups/md5.js"></script>';
echo '<script type="text/javascript" src="./script/js/CryptoJS/components/pad-zeropadding-min.js"></script>';
    
//css样式脚本
echo '<link rel="stylesheet" type="text/css" href="./static/JudgeOnline.css">';
?>